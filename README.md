...
DC1 - Houssam/         # Datacenter 1 (FRR)
  ...
  evpn-vxlan/           # Doc de conception EVPN/VXLAN
...
| Fonctionnalité | DC1 (Houssam) | DC2 (Soyf) | DC3 (Mouhamadi) |
|---|---|---|---|
| Fabric leaf-spine | 3 leafs, 2 spines (FRR) | 3 leafs, 2 spines (Arista cEOS) | 3 leafs, 2 spines (FRR) |
| Underlay | iBGP AS 65000 | iBGP AS 65000 | OSPF |
| Overlay | EVPN/VXLAN VNI 10100 | EVPN/VXLAN VNI 10200 | EVPN/VXLAN VNI 1010 |
| Services web | nginx + HAProxy | nginx | nginx |
| DNS | Unbound | Unbound | Unbound |
| Annuaire | Samba/AD | Samba | Samba |
| Observabilité | SNMP/AgentX + Prometheus + Grafana | gNMI + Telegraf + Grafana | - |
| Tunnel inter-DC | - | VXLAN VNI 1040 vers DC3 | VXLAN VNI 1040 vers DC2 |
